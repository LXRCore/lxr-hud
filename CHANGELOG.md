...
## 3.0.0 — 2026-09-19
* Arrival card: entering a place (the compass's places) shows its name, the hour and the felt temperature once — not again for a while after leaving (`Config.Arrival`).
